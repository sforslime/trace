...
Until the account is purchased, development happens in the iOS Simulator with mock GPX playback for GPS, and short on-device sessions for sensor verification.
